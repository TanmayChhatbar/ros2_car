...
public:
    ...
    void setLinearAccelerations(double vx_, double vy_, double vz_);
    void getLinearAccelerations(double &vx_, double &vy_, double &vz_) const;
    void getAngularAccelerations(double &w_roll_, double &w_pitch_, double &w_yaw_) const;
    void setAngularAccelerations(double w_roll_, double w_pitch_, double w_yaw_);
    void getWheelAccelerations(double &fl_, double &fr_, double &rl_, double &rr_) const;
    void setWheelAccelerations(double fl_, double fr_, double rl_, double rr_);
...
public:
    ...
    void calcLinearAccelerations(double &ax, double &ay, double &az);
    void calcAngularAccelerations(double &a_roll, double &a_pitch, double &a_yaw);
